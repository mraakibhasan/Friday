...
def command():
    ...
    try:
        ...
        if 'Friday' in query:
            ...
            speak("Sir, please take your medicines. I pray to God to heal you soon. Please don't forget to take"
            ...
            speak('Yes sir, I am single till now')
            ...
            os.startfile('C:\\Users\\RA K IB\\Desktop\\friday\\intro.mp3')
